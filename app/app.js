...
function preload () {
    var imageArray = [
	    ...
	    "conflux/conflux/assets/images/memiors.png",
	    ...
	    "conflux/conflux/conflux/assets/images/FreshOffTheBoat.png",
	    "conflux/conflux/assets/images/thelastfiveyears.png",
	    "conflux/assets/images/littlemisssunshine.png",
	    "conflux/conflux/assets/images/sunshinecleaning.png",
	    ...
	    "conflux/conflux/assets/images/harrypotter.png",
        ...
        "conflux/conflux/assets/images/heathers.png",
